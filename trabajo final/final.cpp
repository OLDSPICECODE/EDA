...
void fa(int a, int b, AVL<int> aux) {
    //mtx.lock();
    for (int i = a; i < b; i++) {
        aux.Insertar((rand() % b) + 1);
    }
    //mtx.unlock();
}
...
int main() {
    ...
    AVL<int>tree_4;
    t0 = clock();
    thread th1(fa, 0, 50, tree_4);
    thread th2(fa, 50, 10, tree_4);
    thread th3(fa, 100, 150, tree_4);
    thread th4(fa, 150, 200, tree_4);
    th1.join();
    th2.join();
    th3.join();
    th4.join();
    ...
    AVL<int>tree_5;
    t0 = clock();
    thread th5(fa, 0, 500, tree_5);
    thread th6(fa, 500, 1000, tree_5);
    thread th7(fa, 1000, 1500, tree_5);
    thread th8(fa, 1500, 2000, tree_5);
    th5.join();
    th6.join();
    th7.join();
    th8.join();
    ...
    AVL<int>tree_6;
    t0 = clock();
    thread th9(fa, 0, 5000, tree_6);
    thread th10(fa, 5000, 10000, tree_6);
    thread th11(fa, 10000, 15000, tree_6);
    thread th12(fa, 15000, 20000, tree_6);
    th9.join();
    th10.join();
    th11.join();
    th12.join();
    ...
    AVL<int>tree_7;
    t0 = clock();
    thread th13(fa, 0, 500000, tree_7);
    thread th14(fa, 500000, 1000000, tree_7);
    thread th15(fa, 1000000, 1500000, tree_7);
    thread th16(fa, 1500000, 2000000, tree_7);
    th13.join();
    th14.join();
    th15.join();
    th16.join();
    ...
    AVL<int>tree_8;
    t0 = clock();
    thread th17(fa, 0, 5000000, tree_8);
    thread th18(fa, 5000000, 10000000, tree_8);
    thread th19(fa, 10000000, 15000000, tree_8);
    thread th20(fa, 15000000, 20000000, tree_8);
    th17.join();
    th18.join();
    th19.join();
    th20.join();
